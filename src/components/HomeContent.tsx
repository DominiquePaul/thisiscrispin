      ...
      <section className="flex-grow-0 pt-[30vh] px-[5%] sm:px-[10%] 2xl:px-[20%]">
        <div className="max-w-3xl">
          ...
          >
            ...
            <p>
              Life is about creating value for people who share your values. For me, that&apos;s builders and entrepreneurs. It took leaving Europe to see how much what we have here is worth. But for European values to stay relevant, Europe has to change, particularly how society thinks about AI. Young technologists are our sharpest edge. Yet too many leave technical universities convinced they can&apos;t just build whatever they want.
            </p>
            <p>
              So <a href="https://dream-machines.eu/" className="underline decoration-1 underline-offset-4 decoration-[#C0C0C0] transition-colors hover:decoration-[rgb(90,90,98)]" target="_blank" rel="noopener noreferrer">I build AI that learns manual work</a> by watching people do it, starting where Europe&apos;s strength lives and where robotic AI will change the most: small manufacturers who want to match the output of companies ten times their size. Along the way <a href="https://thisiscrispin.substack.com" className="underline decoration-1 underline-offset-4 decoration-[#C0C0C0] transition-colors hover:decoration-[rgb(90,90,98)]" target="_blank" rel="noopener noreferrer">I write about the journey</a>, messy parts included, and create spaces for technical builders to meet.
            </p>
          </div>
          <div className="mt-12">
