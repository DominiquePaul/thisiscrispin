...
// Fill in missing days in the range so the chart always shows a full 30-bar grid
function fillDailyGaps(data: DailyView[]): DailyView[] {
...
export default function DashboardClient() {
  ...
  const viewsToday = data?.daily.find(d => d.day === today)?.views ?? 0;
      ...
      <div className="max-w-3xl py-12">
        ...
        {data && (
          <>
            ...
            {/* 30-day bar chart */}
            <div className="mb-16">
              <div className="text-[#9A9A9A] text-[10px] uppercase tracking-[0.2em] mb-4">Daily views — last 30 days</div>
